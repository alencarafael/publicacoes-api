...
You can then execute your native executable with: `./target/publicacoes-api-1.0.0-runner`
...
- OpenAPI Generator - REST com.lexon.Client Generator ([guide](https://docs.quarkiverse.io/quarkus-openapi-generator/dev/index.html)): Generation of Rest Clients based on OpenAPI specification files
...
### REST com.lexon.Client Reactive Jackson:
